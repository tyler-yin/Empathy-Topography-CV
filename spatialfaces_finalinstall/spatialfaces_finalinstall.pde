...
<<<<<<< HEAD
  ...
  textSize(18);
  if (num == 0) {
    rect(width/2, 1.8*height/2, width, 35);
    fill(255);
    text(closer, width/2, 1.8*height/2);
  }
  if (num == 1) {
    rect(width/2, 1.8*height/2, width, 35);
    fill(255);
    text(friend, width/2, 1.8*height/2);
  }
  if (num > 1) {
    rect(width/2, 1.8*height/2, width, 35);
    fill(255);
    text(distance[0] + int(dist/10) + distance[1], width/2, 1.8*height/2);
  }
  // {
