...
String [] friend = {"Four eyes look smarter than two. More eyes, please.", "Sometimes I see faces that aren't really there...probably because I'm lonely. I'd be less lonely if you found a friend to join us."};
